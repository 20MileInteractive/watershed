...
var count=document.createElement('script');count.type='text/javascript';count.async=true;count.src='//hello.myfonts.net/count/287158';var s=document.getElementsByTagName('script')[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if(typeof(woffEnabled)=='undefined'){var woffEnabled=true;}
...
suffix="_unhinted";var fonts=[{"fontFamily":"TrendSansOne","url":wfpath+"287158_0"+suffix+"_0."+webfontType}];var len=fonts.length;if(webfontType=="ttf"){var data_fn=suffix=="_unhinted"?"287158_data_unhintedttf.css":"287158_datattf.css";document.write("<link rel='stylesheet' type='text/css' href='"+wfpath+data_fn+"'>");}
else if(webfontType=="woff"){var data_fn=suffix=="_unhinted"?"287158_data_unhintedwoff.css":"287158_datawoff.css";document.write("<link rel='stylesheet' type='text/css' href='"+wfpath+data_fn+"'>");}
